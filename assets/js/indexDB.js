...
export let db = exptrcker("ExpenseTracker", {
    ...
    group_expense: `++id, groupname, team_member, category, date, info`,
    group_income: `++id, groupname, team_member, category, date, info`,
    ikub_expense: `++id, ikubname, team_member, begin_date, interval, amount_per_round, punishment_fee, info`,
});